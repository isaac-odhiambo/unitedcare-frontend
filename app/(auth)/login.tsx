...
import { getErrorMessage, saveAuthTokens } from "@/services/api";
...
function pickTokenFromLoginResponse(data: any): string | null {
  const token =
    data?.token ??
    data?.access ??
    data?.access_token ??
...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      await saveLoginPersistence({
        keepSignedIn: rememberMe,
        phone: cleanPhone,
        token,
      });
